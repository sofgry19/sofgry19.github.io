...
$destinationEmail = "RITISTprofessor@gmail.com,Jim.Habermas@rit.edu,sdg3149@rit.edu";
...
if(!($native == "")){
	$emailBody .= "Native of New York?: $native\n";
}
...
<body>
  ...
  <img id="feedback" class="center image" src="images/feedback.jpg" alt="Thank You for Your Feedback" title="Thank You for Your Feedback">
</body>
</html>
